...
router.post('/:groupId/events', restoreUser, requireAuth, async (req, res, next) => {
    try {
        ...
        if (capacity === undefined || capacity === null || !Number.isInteger(capacity)) errors.capacity = "Capacity must be an integer";
        if (price === undefined || price === null || isNaN(price) || price < 0) errors.price = "Price is invalid";
