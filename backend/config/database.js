...
module.exports = {
  ...
  production: {
    use_env_variable: 'postgres://app_academy_project_dtqa_user:nHbBRglMYHBvkbdH2V3hmWXuJq3e634P@dpg-cm28c621hbls73eo3ogg-a.oregon-postgres.render.com/app_academy_project_dtqa',
    dialect: 'postgres',
    seederStorage: 'sequelize',
    dialectOptions: {
      ssl: {
